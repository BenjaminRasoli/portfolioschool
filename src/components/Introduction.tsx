...
function Introduction() {
  return (
    <div className="w-full min-h-[50vh] bg-Main text-White flex justify-center flex-col text-center items-center">
      <div className="w-full md:max-w-4xl px-4">
        <h1 className="text-h1">Hi, I’m Matt. Nice to meet you.</h1>
